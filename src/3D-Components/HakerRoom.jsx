...
const HackerRoom = (props) => {
  const { nodes, materials } = useGLTF("src/public/models/hacker-room.glb");

  const monitortxt = useTexture("src/public/textures/desk/monitor.png");
  const screenTxt = useTexture("src/public/textures/desk/screen.png");
...
useGLTF.preload("src/public/models/hacker-room.glb");
